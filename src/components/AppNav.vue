    ...
    <v-app-bar color="#02218f" class="pt-3" height="fit-content" absolute>
      <v-container fluid="">
        <v-row>
          ...
          <v-col cols="4">
            <div
              class="parent d-flex justify-center align-center"
              style="gap: 35px"
            >
              <div class="available">
              ...
              <div class="wishlists d-flex flex-column align-center">
                ...
                <span style="color: #ffb547" class="mt-1">Wish List</span>
              </div>
              <div class="wishlists d-flex flex-column align-center">
                <svg
              ...
              <!-- open card shopping section -->
              <div
                class="wishlists d-flex flex-column align-center"
                :style="`cursor: pointer; pionter-events:${
          ...
          <v-col cols="3">
            <ul
              class="links text-white d-flex justify-space-between align-center"
          ...
          <v-col cols="5"></v-col>
          <!--====================== Language & Help =========================== -->
          <v-col cols="4 d-flex justify-end" style="gap: 35px">
            <!-- help content -->
                ...
                <v-list v-model:selected="selectedLang" mandatory>
                  ...
                  >
                    <v-list-item-title
                      ...
                      style="gap: 10px"
                    >
                      <span v-html="lang.icon"></span> {{ icon }} /
                      {{ lang.currency }}
                    </v-list-item-title>
                  </v-list-item>
                </v-list>
